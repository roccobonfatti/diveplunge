...
function getCoords(s: any): [number, number] | null {
  ...
  const src = (typeof (s.position ?? s.coords ?? s.location) === "object" && (s.position ?? s.coords ?? s.location)) || s;
...
export default function Map({ center, spots, onSpotClick, onRequestCreate }: Props) {
